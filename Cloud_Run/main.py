...
config_json = os.environ['SECRETS']
...
def insert(request):
    ...
    if request_args and 'population' in request_args.keys() and '1' == request_args['population']:
        update_population()
    else:
        update_tables(ast.literal_eval(os.environ['CITIES']))
